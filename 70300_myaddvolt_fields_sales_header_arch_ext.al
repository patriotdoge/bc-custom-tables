tableextension 70300 "Sales Header Archive Ext" extends "Sales Header Archive"
{
    fields
    {
        ...
        field(70265; "Engine Generator Config."; Option)
        {
            ...
            DataClassification = CustomerContent;
            OptionMembers = " ","1 Charging with low current","2 Never charging","3 Charging only when reefer is off","4 Charging up to 16A per phase";
        }
        ...
        field(70275; "LVDC Output"; Option)
        {
            Caption = 'LVDC Output';
            DataClassification = CustomerContent;
            OptionMembers = " ","24V OUT(35A)@980W","12V OUT(40A)@560W","24V OUT(75A)@2kW","12V OUT[75A)@1kW";
        }
